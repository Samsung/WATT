...
define(function (require, exports) {
    ...
    /**
     *
     * Convert the project file path to the server-side real path
     *
     * @param {string} filePath
     * @param {string} projectId
     * @return {string} Converted server-side path
     */
    exports.convertFilePathToServerPath = function (filePath, projectId) {
        var serverPath = filePath.split("/");
        serverPath.splice(0, 1);
        serverPath.splice(0, 0, window.location.origin);
