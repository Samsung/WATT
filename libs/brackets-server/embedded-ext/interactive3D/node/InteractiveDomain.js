(function() {
    ...
    function init(domainManager) {
        if (!domainManager.hasDomain("interactiveNodeDomain")) {
            domainManager.registerDomain("interactiveNodeDomain", {major: 0, minor: 1});
        }
                            ...
                            if (ext === ".zip") {
                                ...
                                extract(zipPath, {dir: downloadPath}, extractErr => {
                                    ...
                                    for (const value of files) {
                                        ...
                                        } else if (path.extname(value) === ".gltf") {
                                            object.type = "gltf";
                                            object.files.push({
                                                type: object.type,
                                                file: value
        ...
        function copyModel(projectId, modelId, callback) {
            ...
            var destPath = path.join(projectPath, "i3d", "models", modelId);
