...
define(function (require, exports, module) {
    ...
    */
    ...
    function _appendNewScript(eventParams) {
        var element = $(eventParams.template).appendTo(eventParams.containerElement).show();
    ...
    $(document).on("design.editor.event","#html-design-editor",function(event, type, eventParams,profile){
        if(profile === 'html' || profile === 'custom'){
            ...
            } else if (type === "create.new.script") {
                _appendNewScript(eventParams);
            }
        }
    });
